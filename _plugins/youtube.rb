  ...
  class BetterTube < Liquid::Tag
    ...
    def render(context)
      ...
      if @ytid
        ...
        thumbnail = "<figure class='BetterTube' data-youtube-id='#{id}' data-player-width='#{w}' data-player-height='#{h}' id='#{id}' style='padding-bottom: #{padding_bottom}'><a class='BetterTubePlayer' href='https://www.youtube.com/watch?v=#{id}' rel='noopener noreferrer' target='_blank' style='background: url(https://i.ytimg.com/vi/#{id}/hqdefault.jpg) 50% 50% no-repeat rgb(0, 0, 0);'>&nbsp;</a><div class='BetterTube-playBtn'></div>&nbsp;</figure>"
